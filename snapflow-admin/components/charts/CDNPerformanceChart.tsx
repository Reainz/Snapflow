        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          <div className="flex items-center gap-3">
            ...
            <div>
              ...
              <p className="text-sm text-muted-foreground">Bandwidth (24h)</p>
            </div>
          </div>
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <p className="text-2xl font-bold">{data.downloadRequests.toLocaleString()}</p>
        ...
        <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
          <div className="p-4 border rounded-lg">
            ...
            <p className="text-xs text-muted-foreground">
              {data.downloadRequests > 0
                ? `Average ${((data.bandwidthGB * 1024 * 1024) / data.downloadRequests).toFixed(2)} KB per request`
            ...
            {(['firebase_storage', 'cloudinary'] as const).map((key) => {
              ...
              return (
                <div key={key} className="p-4 border rounded-lg space-y-2">
                  ...
                  <p className="text-sm">
                    Requests: {provider.downloadRequests?.toLocaleString?.() ?? '0'}
                  </p>
