      ...
      <CardContent>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
          <div className="flex flex-col space-y-1 p-4 rounded-lg bg-blue-50 dark:bg-blue-950/30">
            ...
            <span className={`text-2xl font-bold ${getResponseTimeColor(data.overallAvgResponseTime)}`}>
              {formatResponseTime(data.overallAvgResponseTime)}
            </span>
          </div>
          ...
          <div className="flex flex-col space-y-1 p-4 rounded-lg bg-red-50 dark:bg-red-950/30">
            ...
            <span className={`text-2xl font-bold ${getErrorRateColor(data.overallErrorRate)}`}>
