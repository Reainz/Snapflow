...
const flagVideo_1 = require("../../video/flagVideo");
describe('flagVideo Callable Function - Unit Tests', () => {
    ...
    describe('Authentication', () => {
        test('should throw unauthenticated error when user not logged in', async () => {
            ...
            await expect((0, flagVideo_1.flagVideo)(request, {})).rejects.toThrow(expect.objectContaining({
        ...
        test('should allow authenticated user to proceed', async () => {
            ...
            const result = await (0, flagVideo_1.flagVideo)(request, {});
    ...
    describe('Rate Limiting', () => {
        ...
        test('should include retryAfterSeconds in error details', async () => {
            ...
            try {
                await (0, flagVideo_1.flagVideo)(request, {});
...
//# sourceMappingURL=flagVideo.test.js.map