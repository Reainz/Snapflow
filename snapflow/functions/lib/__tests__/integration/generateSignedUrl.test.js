...
jest.mock('../../utils/cloudinary', () => ({
    isCloudinaryUrl: jest.fn((url) => url.includes('res.cloudinary.com')),
    extractPublicIdFromUrl: jest.fn((url) => {
        if (url.includes('snapflow/processed/video123')) {
            return 'snapflow/processed/video123/file';
        }
        return null;
    }),
    generateSignedCloudinaryUrl: jest.fn((publicId) => {
...
//# sourceMappingURL=generateSignedUrl.test.js.map