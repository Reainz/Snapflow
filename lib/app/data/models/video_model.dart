...
class VideoModel extends Equatable {
  ...
  Map<String, dynamic> toJson() => <String, dynamic>{
    ...
    // Canonical field used across Firestore + functions.
    'durationSeconds': duration,
    // Backward-compatible alias (older cache/app code may expect this key).
    'duration': duration,
  ...
  factory VideoModel.fromJson(Map<String, dynamic> json) {
    ...
    return VideoModel(
      ...
      // Prefer canonical durationSeconds; fall back to legacy duration.
      duration: parseInt(json['durationSeconds'] ?? json['duration']),
